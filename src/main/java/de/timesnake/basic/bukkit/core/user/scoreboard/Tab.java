...
public class Tab<E extends TabEntry<E>> implements Iterable<E> {
   ...
   *
   * <p>
   * The entry will be added so that the resulting list is in a lexicographic order. If the entry
   * has the same rank as another entry, the merge method on the existing entry will be called.
   * </p>
   *
