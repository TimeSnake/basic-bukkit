...
public class DelegatedWorld implements World {
  ...
  @Override
  public @NotNull Chunk getChunkAt(long chunkKey) {
  ...
  @Override
  public @NotNull Collection<LivingEntity> getNearbyLivingEntities(@NotNull Location loc,
      double radius) {
  ...
  @Override
  public @NotNull Collection<Player> getNearbyPlayers(@NotNull Location loc, double xzRadius,
      double yRadius) {
    return world.getNearbyPlayers(loc, xzRadius, yRadius);
  }

  @Override
  public @NotNull Collection<Player> getNearbyPlayers(@NotNull Location loc, double xRadius,
      double yRadius,
      double zRadius) {
  ...
  public @NotNull Collection<Player> getNearbyPlayers(@NotNull Location loc, double xRadius,
      double yRadius,
      double zRadius, @Nullable Predicate<Player> predicate) {
    return world.getNearbyPlayers(loc, xRadius, yRadius, zRadius, predicate);
  }

  @Override
  public @NotNull <T extends Entity> Collection<T> getNearbyEntitiesByType(
  ...
  @Override
  public void getChunkAtAsync(int x, int z, boolean gen,
      java.util.function.@NotNull Consumer<Chunk> cb) {
    world.getChunkAtAsync(x, z, gen, cb);
  }

  @Override
  public void getChunkAtAsync(@NotNull Location loc,
      java.util.function.@NotNull Consumer<Chunk> cb) {
    world.getChunkAtAsync(loc, cb);
  }

  @Override
  public void getChunkAtAsync(@NotNull Location loc, boolean gen,
      java.util.function.@NotNull Consumer<Chunk> cb) {
    world.getChunkAtAsync(loc, gen, cb);
  }

  @Override
  public void getChunkAtAsync(@NotNull Block block,
      java.util.function.@NotNull Consumer<Chunk> cb) {
    world.getChunkAtAsync(block, cb);
  }

  @Override
  public void getChunkAtAsync(@NotNull Block block, boolean gen,
      java.util.function.@NotNull Consumer<Chunk> cb) {
  ...
  @Override
  public @NotNull Collection<Entity> getNearbyEntities(@NotNull Location location, double x,
      double y, double z) {
  ...
  public @Nullable RayTraceResult rayTraceEntities(@NotNull Location start,
      @NotNull Vector direction,
      double maxDistance, @Nullable Predicate<Entity> filter) {
  ...
  @Override
  @Deprecated
  public void setTicksPerWaterUndergroundCreatureSpawns(
      int ticksPerWaterUndergroundCreatureSpawns) {
  ...
  public <T> void spawnParticle(@NotNull Particle particle, @Nullable List<Player> receivers,
      ...
      double offsetY, double offsetZ, double extra, @Nullable T data) {
    world.spawnParticle(particle, receivers, source, x, y, z, count, offsetX, offsetY, offsetZ,
        extra, data);
  }
  ...
  @Override
  public boolean generateTree(@NotNull Location location, @NotNull Random random,
  ...
  @Override
  public <T extends Entity> @NotNull T spawn(@NotNull Location location, @NotNull Class<T> clazz,
      @Nullable Consumer<T> function) throws IllegalArgumentException {
  ...
  @Override
  public <T extends Entity> @NotNull T spawn(@NotNull Location location, @NotNull Class<T> clazz,
      boolean randomizeData, @Nullable Consumer<T> function) throws IllegalArgumentException {
